...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/admin/users/{id}/enable", post(actions::enable_user))
        .route("/admin/users/{id}/rename", post(actions::rename_user))
        .route("/admin/users/{id}/admin", post(actions::toggle_admin))
        ...
        .route("/admin/devices/{id}/delete", post(actions::delete_device))
        .route("/admin/vaults", get(pages::vaults))
        .route("/admin/vaults/{id}/rename", post(actions::rename_vault))
        .route("/admin/vaults/{id}/delete", post(actions::delete_vault))
        .route("/admin/vaults/{id}/restore", post(actions::restore_vault))
        .route("/admin/vaults/{id}/purge", get(pages::confirm_purge_vault).post(actions::purge_vault))
